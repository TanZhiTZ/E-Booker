    ...
    <body>
        ...
        <div>
            <ul class="header container-fluid">
                <li>
                    <a href="index.php#all-books" class="header btn "><button class="btn-frame"><span>All</span></button></a>
                </li>
                <li>
                    <a href="index.php" class="header btn "><button class="btn-frame"><span>Manga</span></button></a>
                </li>
                <li>
                    <a href="index.php" class="header btn "><button class="btn-frame"><span>LightNovel</span></button></a>
                </li>
                <li>
                    <a href="index.php" class="header btn "><button class="btn-frame"><span>Doujinshi</span></button></a>
                </li>
                <li>
                    <a href="index.php" class="header btn "><button class="btn-frame"><span>Free</span></button></a>
                </li>
            </ul>
        </div>
        ...
        <!-- Main Content & Books -->
            <div class="main row align-items-start">
                ...
                <div class="left-main col-sm" style="min-width: 80%; max-width: auto;">
                    ...
                    <div id="all-books" style="padding-left: 15px;">
                    <?php
                    ini_set('display_errors', '0');
                    $kw = NULL;
                    $kw = $_POST['bookSearch'];
                    if ($kw) {
                        $json = file_get_contents("http://localhost/e_booker/api/product/search.php?s=$kw");
                        $data = json_decode($json);
                        ini_set('display_errors', 0);

                        if ($data->message)
                        echo "<div style='color: red; padding-top: 23px; width: 95%; text-align: center;'>$data->message</div>";
                            ...
                            foreach ($data->records as $idx => $records) {
                                ...
                                echo "<div id='book' style='width:266px;'>
                                                ...
                                                <div class='book-button'>
                                                    <ul class='books'>
                                                        <li class='preview'>
                                                            <a href='book-description.php?id=$records->id' class='preview'>Preview</a>
                                                        </li>
                                                        <li class='cart'>";
                    ...
                    else echo "<div style='padding-top: 23px; width: 95%; text-align: center;'>Theres nothing here but us chikens!<?div>";
